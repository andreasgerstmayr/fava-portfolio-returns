    ...
    <div className="help-text">
      ...
      <Trans>
        ...
        <p>
          ...
          February. At the end of February, the investment is worth 200 USD. In other words, you invested 100 USD for
          two months (59 days), and 20 USD for one month (28 days). IRR calculates <code>x</code> of the following
          formula: <code>100*(1+x)^(59/365) + 20*(1+x)^(28/365) = 200</code>.
        </p>
      ...
      <Trans>
        ...
        <p>
          ...
          investment are 50% (<code>150/100-1</code>). Because of these returns, you decide to invest additional 100
          USD. Now, the returns dropped to 25% (<code>250/200-1</code>), even though the price of the commodity did not
          change. The TWR eliminates this effect, which allows us to compare different portfolios without the effects of
          cash flows.
        </p>
