...
def intervals_periods(start_date: datetime.date, end_date: datetime.date) -> list[Interval]:
    periods = [
        ...
        ("1Y", end_date - relativedelta(years=1), end_date),
        ("2Y", end_date - relativedelta(years=2), end_date),
        ("3Y", end_date - relativedelta(years=3), end_date),
        ("4Y", end_date - relativedelta(years=4), end_date),
        ("5Y", end_date - relativedelta(years=5), end_date),
        ("10Y", end_date - relativedelta(years=10), end_date),
        ("15Y", end_date - relativedelta(years=15), end_date),
