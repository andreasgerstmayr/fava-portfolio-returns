...
from fava_portfolio_returns._vendor.beangrow.config_pb2 import Config
from fava_portfolio_returns._vendor.beangrow.config_pb2 import InvestmentConfig
from fava_portfolio_returns._vendor.beangrow.config_pb2 import GroupConfig
